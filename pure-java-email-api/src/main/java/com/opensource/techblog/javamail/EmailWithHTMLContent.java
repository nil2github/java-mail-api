...
public class EmailWithHTMLContent {
	...
	public static void main(String[] args) {
		...
		try {
			...
			message.setSubject("Sending Mail with pure Java Mail API 2...");
			
			/**
			 * Enable either one of these - mail body as Plain Text or HTML content  
			 */
	 ...
	 */
	private static Multipart prepareHtmlContent() throws MessagingException {
